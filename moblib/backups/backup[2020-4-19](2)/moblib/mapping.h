...
inline sint mapX(mlMovimentInstance* self, mlSheet *sheet, sint x, sint y) { return self->x + x * sheet->cellWidth; }
// retorna a posicao Y na tela
inline sint mapY(mlMovimentInstance* self, mlSheet *sheet, sint x, sint y) { return self->y + y * sheet->cellHeight; }
