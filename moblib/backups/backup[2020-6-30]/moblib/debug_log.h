...
ofstream cache_log("moblib/moblibDebug.log", ios::trunc);
		...
		void debugLog(std::string valueString1, short int valuenumber1, std::string valueString2, short int valuenumber2, std::string valueString3, short int valuenumber3) {

			std::cout << contarw + valueString1 + ' ' << valuenumber1 << " # " + valueString2 + ' ' << valuenumber2 << " # " + valueString3 + ' ' << valuenumber3 << std::endl;
			cache_log << contarw + valueString1 + ' ' << valuenumber1 << " # " + valueString2 + ' ' << valuenumber2 << " # " + valueString3 + ' ' << valuenumber3 << std::endl;
		}
		#endif
