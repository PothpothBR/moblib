...
// paleta de cores tudo ou nada

#define red al_map_rgb(25, 0, 0)  //azul clarinho
#define green al_map_rgb(0, 255, 245)  //azul clarinho
#define blue al_map_rgb(0, 0, 255)  //azul clarinho
