...
struct SpriteMovimentStance {
	...
	SpriteMovimentStance(float x, float y) {
		this->x = x;
		this->y = y;
		debugLog("created obj <SpriteMovimentStance>");
		debugLog("position X:", x, "Y:", y);
	}
	~SpriteMovimentStance(){ debugLog("destructing obj <SpriteMovimentStance>"); }
};
...
public:
	...
	SpriteMovimentKeys(float x, float y, usint vel=0): SpriteMovimentStance(x, y) {
...
struct SpriteMovimentClick : public SpriteMovimentStance {
	...
	SpriteMovimentClick(float x, float y) : SpriteMovimentStance(x, y) {
...
struct SpriteMoviment : public SpriteMovimentStance {
	...
	SpriteMoviment(float x, float y) : SpriteMovimentStance(x, y) {
